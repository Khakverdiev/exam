...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        services.AddCors(options =>
        {
            ...
            {
                builder.WithOrigins("https://localhost:3000", "https://localhost:3001", "https://localhost:7193")
                    .AllowAnyMethod()
                    .AllowAnyHeader()
                    .AllowCredentials();
            });
        ...
        var blobConnectionString = _configuration["BlobConnection:ConnectionString"];
        ...
        var mapperConfig = ProductMappingConfiguration.ConfigureProductMappings();
