...
public class TokenService : ITokenService
{
    ...
    public async Task<string> GenerateTokenAsync(User user)
    {
        ...
        if (role == null)
        {
            throw new MyAuthException(AuthErrorTypes.InvalidRole, "User role not found");
        }

        var isAdmin = role.AppRole.Name == "AppAdmin";
        ...
        var expiration = isAdmin ? DateTime.UtcNow.AddMinutes(10) : DateTime.UtcNow.AddMinutes(10);
