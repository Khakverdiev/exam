...
const MyReview = () => {
    ...
    const fetchMyReviews = async () => {
        ...
        try {
            ...
            const response = await axios.get(`https://localhost:7193/api/reviews/user/${username}`, {
    ...
    const handleSaveEdit = async () => {
        try {
            ...
            await axios.put(`https://localhost:7193/api/reviews/${editingReview.id}`, updatedReview, {
                headers: {
